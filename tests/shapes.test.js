    ...
    describe('Triangle', () => {
        test("A triangle that is purple and has the letters ABC in the center written in white", () => {
            const triangle = new Triangle(
                ...
                'white',
                'purple');
            expect(triangle.render()).toBe(`<svg width="300" height="200" xmlns="http://www.w3.org/2000/svg"><polygon points="150, 18 244, 182 56, 182" fill="purple"/><text y="125" x="150" alignment-baseline="middle" fill="white" text-anchor="middle" font-size="45">ABC</text></svg>`
            );
        });
    });
    ...
    describe('Square', () => {
        test("A square that is pink and has the letters OK in the center written in blue", () => {
            const square = new Square(
                ...
                'blue',
                'pink');
            expect(square.render()).toBe(`<svg width="300" height="200" xmlns="http://www.w3.org/2000/svg"><rect x="0" y="0" height="200" width="200" fill="pink"/><text y="100" x="150" alignment-baseline="middle" fill="blue" text-anchor="middle" font-size="80">OK</text></svg>`
            );
        });
    });
